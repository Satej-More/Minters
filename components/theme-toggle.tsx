...
export function ThemeToggle() {
  ...
  return (
    <Button
      ...
      className="rounded-full w-10 h-10 bg-white/10 hover:bg-white/20 dark:bg-black/20 dark:hover:bg-black/30 backdrop-blur-md border border-white/10 transition-all duration-300"
    >
